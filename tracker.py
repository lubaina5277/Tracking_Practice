# https://www.youtube.com/watch?v=artj811O5SY
...
# icon image
icon = PhotoImage(file="track_pro\logo image.png")
root.iconphoto(False,icon)

# logo
logo = PhotoImage(file="track_pro\logo image.png")
Label(root,image=logo).place(x=240, y=70)

Eback = PhotoImage(file="track_pro\search png.png")
...
#bottom box
# Box1 = PhotoImage(file="track_pro\bottom png.png")
# Label(root,image=Box1).place(x=-2, y=355)
...
#search button
Search_image = PhotoImage(file="track_pro\search.png")
